...
folders = { ...
    %"C:\Users\jlaco\OneDrive\Escritorio\1\Procesado de Señales Multimedia\Proyecto\ProyectoPSM\Database\test_amarillas"
    %"C:\Users\jlaco\OneDrive\Escritorio\1\Procesado de Señales Multimedia\Proyecto\ProyectoPSM\Database\test_rojas"
};

% --- Carpeta destino ---
basePath   = "C:\Users\jlaco\OneDrive\Escritorio\1\Procesado de Señales Multimedia\Proyecto\ProyectoPSM\Database";
%saveFolder = fullfile(basePath, "SEGMENTED_amarillas_local");
%saveFolder = fullfile(basePath, "SEGMENTED_rojas_local");
