...
namespace FeatureExtractor {
    ...
    // helper: rejilla NxN con fracci�n de pixeles "on" por celda
    ...
    // ----------------- Shape features (14) - versi�n compatible con MATLAB -------------
    // Implementa la l�gica del local_extractShapeFeatures(matlab) usada por ExtractColorShapeFeatures.
    static std::vector<double> local_extractShapeFeatures_14(const cv::Mat& I_float01) {
        ...
        cv::Mat maskN = (maskRc > 0); // NOTE: no scale normalization here, faithful a la versi�n MATLAB
